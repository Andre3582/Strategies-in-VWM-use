var jsPsychPipe = function(t)
{
    ...
    function e()
    {
        ...
        return l.prototype = d, s(g, "constructor", d), s(d, "constructor", l), l.displayName = s(d, c, "GeneratorFunction"), t.isGeneratorFunction = function(t)
        {
    ...
    var o = {
        ...
        i = function()
        {
                    ...
                    return n(this, void 0, void 0, e().mark((function n()
                    {
                        ...
                        return e().wrap((function(e)
                        {
                            for (;;) switch (e.prev = e.next)
                            {
                                ...
                                case 2:
                                    return e.prev = 2, e.next = 5, fetch("https://pipe.jspsych.org/api/data/",
                                    {
                                        method: "POST",
                                        headers:
                                        {
                                ...
                                case 5:
                                    ...
                                    break;
                                case 8:
                                    return e.prev = 8, e.t0 = e.catch(2), e.abrupt("return", e.t0);
                                case 11:
                        ...
                        return e().wrap((function(e)
                        {
                            for (;;) switch (e.prev = e.next)
                            {
                                case 0:
                                    ...
                                    throw new Error("Missing required parameter(s).");
                                case 2:
                                    return e.prev = 2, e.next = 5, fetch("https://pipe.jspsych.org/api/base64/",
                                    {
                                        method: "POST",
                                        headers:
                                        {
                        ...
                        return e().wrap((function(e)
                        {
                            for (;;) switch (e.prev = e.next)
                            {
                                case 0:
                                    ...
                                    throw new Error("Missing required parameter(s).");
                                case 2:
                                    return e.prev = 2, e.next = 5, fetch("https://pipe.jspsych.org/api/condition/",
                                    {
                                        method: "POST",
                                        headers:
                                        {
                                ...
                                case 13:
                                    return o = e.sent, e.abrupt("return", o.condition);
                                case 15:
                                case "end":
                                    return e.stop()
                            }
                ...
                value: function(r, o)
                {
                    return n(this, void 0, void 0, e().mark((function n()
                    {
                        ...
                        return e().wrap((function(e)
                        {
                            ...
                            {
                                case 0:
                                    if (i = "\n      <style>".concat("\n      .spinner {\n        animation: rotate 2s linear infinite;\n        z-index: 2;\n        position: absolute;\n        top: 50%;\n        left: 50%;\n        margin: -25px 0 0 -25px;\n        width: 50px;\n        height: 50px;\n      }\n        \n      .spinner .path {\n        stroke: rgb(25,25,25);\n        stroke-linecap: round;\n        animation: dash 1.5s ease-in-out infinite;\n      }\n\n      @keyframes rotate {\n        100% {\n          transform: rotate(360deg);\n        }\n      }\n      \n      @keyframes dash {\n        0% {\n          stroke-dasharray: 1, 150;\n          stroke-dashoffset: 0;\n        }\n        50% {\n          stroke-dasharray: 90, 150;\n          stroke-dashoffset: -35;\n        }\n        100% {\n          stroke-dasharray: 90, 150;\n          stroke-dashoffset: -124;\n        }\n      }\n    ", '</style>\n      <svg class="spinner" viewBox="0 0 50 50">\n        <circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="5"></circle>\n      </svg>'), r.innerHTML = i, "save" !== o.action)
                                    {
                                        e.next = 7;
                                        break
                                    }
                                    return e.next = 6, t.saveData(o.experiment_id, o.filename, o.data_string);
                                case 6:
                                    a = e.sent;
                                case 7:
                                    ...
                                    return e.next = 10, t.saveBase64Data(o.experiment_id, o.filename, o.data_string);
                                case 10:
                                    a = e.sent;
                                case 11:
                                    ...
                                    return e.next = 14, t.getCondition(o.experiment_id);
                                case 14:
                                    a = e.sent;
                                case 15:
                                    r.innerHTML = "", c = {
            ...
            }]) && r(o.prototype, i), a && r(o, a), Object.defineProperty(o, "prototype",
            {
                writable: !1
            }), t
        }();
